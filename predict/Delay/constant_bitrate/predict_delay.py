...
from predict.Delay.constant_bitrate.read_dataset import input_fn, network_to_hypergraph
from predict.Delay.constant_bitrate.model import GNN_Model
from predict.Delay.constant_bitrate.datanetAPI import DatanetAPI
...
class Predict_delay():
    ...
    def predict(self):
        ...
        ds_test = input_fn('/opt/DRL-OR-DEV/data_GEA/traffic_models/constant_bitrate/train', label='delay', shuffle=False)
        ...
        tool = DatanetAPI('/opt/DRL-OR-DEV/data_GEA/traffic_models/constant_bitrate/train', shuffle=False)
        it = iter(tool)
        index = 0
        num_samples = 0
        predict_delay = []
